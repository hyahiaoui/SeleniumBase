...
class MD_F:
    ...
    def get_parent_class_lang(parent_class):
        ...
        if parent_class not in parent_class_lang.keys():
            raise Exception(
                "Invalid parent_class {%s} not in {%s}!" "" % (parent_class, parent_class_lang.keys())
            )
...
class MD:
    ...
    md["click_link_text"][3] = "cliquez_texte_du_lien"
    ...
    md["switch_to_default_content"][8] = "переключиться_на_содержимое_по_умолчанию"
    ...
    md["press_up_arrow"][3] = "appuyez_sur_flèche_haut"
    ...
    md["press_down_arrow"][3] = "appuyez_sur_flèche_bas"
    ...
    md["press_left_arrow"][3] = "appuyez_sur_flèche_gauche"
    ...
    md["press_right_arrow"][3] = "appuyez_sur_flèche_droite"
    ...
    md["set_attributes"][3] = "définir_les_attributs"
    ...
    md["click_link"][3] = "cliquez_texte_du_lien"
    ...
    md["set_attribute_all"][3] = "définir_les_attributs"
