...
class App:
    def __init__(self, master):
        ...
        self.run1 = Button(
            frame, command=self.run_1, text=("pytest my_first_test.py --browser=chrome"), fg="green",
        ).pack()
        self.title2 = Label(frame, text=("Run a Test in Firefox:"), fg="blue").pack()
        self.run2 = Button(
            frame, command=self.run_2, text=("pytest my_first_test.py --browser=firefox"), fg="green",
        ).pack()
        ...
        self.title4 = Label(frame, text="Run a Parameterized Test:", fg="blue").pack()
        self.run4 = Button(
            frame, command=self.run_4, text=("pytest parameterized_test.py --browser=chrome"), fg="green",
        ).pack()
        self.title5 = Label(frame, text="Run a Failing Test (automatic screenshots):", fg="blue").pack()
        self.run5 = Button(
            frame, command=self.run_5, text=("pytest test_fail.py --browser=chrome"), fg="red",
        ).pack()
        self.title6 = Label(frame, text="Run a Failing Test Suite with a Test Report:", fg="blue").pack()
        self.run6 = Button(
            frame,
            command=self.run_6,
        ...
        self.title7 = Label(frame, text="Run a Failing Test with Delayed Asserts:", fg="blue").pack()
        self.run7 = Button(
            frame, command=self.run_7, text=("pytest test_delayed_asserts.py --browser=chrome"), fg="red",
        ).pack()
    ...
    def run_7(self):
        os.system("pytest test_delayed_asserts.py --browser=chrome")
